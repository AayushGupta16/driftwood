...
try {
 ...
 await page.locator('.overview-campaign-list a').first().waitFor();
 ...
 const selectors={linkedin:'.overview-sending',results:'.overview-metrics',pipeline:'.overview-campaign-desk',latest:'.overview-latest-sends',leads:'.overview-add',blacklist:'.overview-imports'};
 const regions={};
