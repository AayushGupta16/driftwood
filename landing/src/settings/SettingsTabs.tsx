...
const items = [["Send schedule", "/dashboard/settings"], ["Sending accounts", "/dashboard/settings?tab=accounts"], ["Approvals", "/dashboard/settings?tab=approvals"], ["Product & brand assets", "/dashboard/assets"], ["Team", "/dashboard/team"]];
